...
class Lowerface extends StatelessWidget {
...
class _ImageGridItemState extends State<ImageGridItem> {
  ...
  Uint8List imagefile;
  StorageReference eyeReference = FirebaseStorage.instance.ref().child("Lowerface");

  getImage(){
    int MAX_SIZE = 4*1024*1024;
    eyeReference.child("lface${widget._index}.png").getData(MAX_SIZE).then((data){
      this.setState((){
        imagefile = data;
        //print(widget._index);
      });
